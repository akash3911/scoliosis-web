...
export interface IStoreState {
  ...
  setScoliotectAPIResponse: (responseData?: ScoliotectAPIResponseType) => void;
  ...
  setDetectionColor: (color: string) => void;
  setDetectionTextSize: (size: number) => void;
  setLineColor: (color: string) => void;
  setLineScale: (scale: number) => void;
  setCobbLineScale: (scale: number) => void;
  setCobbTextSize: (size: number) => void;
}
...
export const useStore = create<IStoreState>()(
  devtools(
    immer((set) => ({
      ...
      scoliotectAPIResponse: undefined,
      setScoliotectAPIResponse: (responseData) =>
        set((state) => {
          state.scoliotectAPIResponse = responseData;
        }),
      ...
      setDetectionColor: (color) =>
        set((state) => {
          state.drawSettings.detectionColor = color;
        }),
      setDetectionTextSize: (size) =>
        set((state) => {
          state.drawSettings.detectionTextSize = size;
        }),
      setLineColor: (color) =>
        set((state) => {
          state.drawSettings.lineColor = color;
        }),
      ...
      setLineScale: (scale) =>
        set((state) => {
          state.drawSettings.lineScale = scale;
        }),
      setCobbLineScale: (scale) =>
        set((state) => {
          state.drawSettings.cobbLineScale = scale;
        }),
      setCobbTextSize: (size) =>
        set((state) => {
          state.drawSettings.cobbTextSize = size;
        }),
    }))
  )
);
